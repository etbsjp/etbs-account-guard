...
* [ Bug Fix ] Fixed the "Verify" button for BASIC authentication credentials leaving no indication that the ID and password just entered are usually kept even when WordPress's own "changes you made will be lost" warning appears; added a note next to the button making this clear.
