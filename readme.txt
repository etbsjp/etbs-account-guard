...
* [ Bug Fix ] Fixed the "Verify" button for BASIC authentication credentials always triggering WordPress's own "changes you made will be lost" warning, even with no other edits on the screen; added a note next to the button explaining that leaving the page is safe.
